...
function PhantInput(config) {
  ...
  var responder = function(req, res) {
    ...
    req.query.public_key = arr_path[2];
    ...
    req.query.private_key = (typeof req.headers['phant-private-key'] != 'undefined')
                          ? req.headers['phant-private-key']
                          : obj_url.query.private_key;
...
app.log = function(req, res) {
  ...
  var data = {},
      pub = req.query.public_key,
      prv = req.query.private_key,
      input = this,
      id = false;
